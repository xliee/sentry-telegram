...
Presented plugin tested with Sentry from 8.9 to 9.1.1, 20.12.1.
...
.. |travis| image:: https://travis-ci.org/vortland/sentry-telegram.svg?branch=master
   :target: https://travis-ci.org/vortland/sentry-telegram
   :alt: Build Status
